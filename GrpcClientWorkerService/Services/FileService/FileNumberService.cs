...
{
   public class FileNumberService:IFileNumberService
    {
        ...
        public FileDto GenerateImage(int width, int height)
        {

            var number = this.GenerateNumber();
            ...
            using (Graphics graph = Graphics.FromImage(baseMap))
            {
                ...
                return new FileDto { Number = number, FileByteData = ms.ToArray()};
                ...
                void DrawCaptchaCode()
                {
                    ...
                    int fontSize = GetFontSize(width, number.Length);
                    ...
                    for (int i = 0; i < number.Length; i++)
                    {
                        ...
                        graph.DrawString(number[i].ToString(), font, fontBrush, x, y);
                    }
                }
